...
class DecoderSpin(nn.Module):
    def __init__(self):
        ...
        self.conv1 = gnn.GraphConv(64, 32)
        self.conv2 = gnn.GraphConv(32, 16)
        self.conv3 = gnn.GraphConv(16, 8)
        self.conv4 = gnn.GraphConv(8, 4)
        self.conv5 = gnn.GraphConv(4, 1)
        self.relu = nn.ReLU()
        self.sigmod = nn.Sigmoid()
        self.dropout = nn.Dropout(p=0.5)
        self.bn1 = gnn.BatchNorm(32)
